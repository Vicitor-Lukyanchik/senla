...
public class ServiceDaoImpl implements ServiceDao {
    ...
    public void create(Service service, Connection connection) {
        try (PreparedStatement statement = connection.prepareStatement(INSERT_SERVICE, Statement.RETURN_GENERATED_KEYS)) {
    ...
    public void createWithId(Service service, Connection connection) {
        try (PreparedStatement statement = connection.prepareStatement(INSERT_SERVICE_WITH_ID, Statement.RETURN_GENERATED_KEYS)) {
    ...
    public void update(Service service, Connection connection) {
        try (PreparedStatement statement = connection.prepareStatement(UPDATE_SERVICE, Statement.RETURN_GENERATED_KEYS)) {
            statement.setString(1, service.getName());
            statement.setBigDecimal(2, service.getCost());
    ...
    public List<Service> findAll(Connection connection) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(SELECT_SERVICES)) {
